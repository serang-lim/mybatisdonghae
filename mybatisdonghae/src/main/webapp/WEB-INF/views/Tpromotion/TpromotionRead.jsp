...
<h3 align="center"> 프로모션 상세보기 </h3>
	...
	<tr>
		<th colspan="1">사진</th>
			<td colspan="5"><img src="../storage/${dto.timageName2}" width="80%" height="auto" align="middle"></td>
	</tr>	
	</table>			
	...
	<div align="center" style="padding: 1%  1%  1%  1%;">
		...
		<c:if test="${sessionScope.s_mlevel=='B1'}"><!-- 멤버레벨이 관리자면 보여짐 -->
			<input type="button" value="프로모션수정" onclick="location.href='TpromotionUpdate.do'">
		...
		<input type="button" value="예약하기" onclick="location.href='Treserve.do?tbno=${dto.tbno}'">

...
<h2 align="center"> 프로모션 상세보기 </h2>
	...
	<tr>
		...
		<th>분류</th>
			<td>
			<c:if test="${dto.ticon=='숙소'}"><img src="../resoures/images/zam.png" width="35px"></c:if>
			<c:if test="${dto.ticon=='주위식당'}"><img src="../resoures/images/bob.png" width="35px"></c:if>
			<c:if test="${dto.ticon=='주요행사'}"><img src="../resoures/images/fe.png" width="35px"></c:if>
			<c:if test="${dto.ticon=='액티비티'}"><img src="../resoures/images/act.png" width="35px"></c:if>
			<c:if test="${dto.ticon=='사진스팟'}"><img src="../resoures/images/sajin.png" width="35px"></c:if>
			</td>
		<th>지역</th>
			<td>
			<c:if test="${dto.tregion=='강릉'}"><img src="../resoures/images/강릉.png" width="35px"></c:if>
			<c:if test="${dto.tregion=='삼척'}"><img src="../resoures/images/삼척.png" width="35px"></c:if>
			<c:if test="${dto.tregion=='속초'}"><img src="../resoures/images/속초.png" width="35px"></c:if>
			<c:if test="${dto.tregion=='동해'}"><img src="../resoures/images/동해.png" width="35px"></c:if>
			</td>
	</tr>
	<tr>
		<th>작성자</th>

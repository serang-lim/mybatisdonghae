...
<!-- 본문 시작 Treview.jsp -->
   ...
   <tr height="30">
      ...
      <c:forEach var="reg" items="${rregion}" varStatus="g">
            <c:if test="${fn:split(dto.rregion,',')[g.count-1]=='속초'}"><img src="../resources/images/속초.png" width="30px"></c:if>
            <c:if test="${fn:split(dto.rregion,',')[g.count-1]=='강릉'}"><img src="../resources/images/강릉.png" width="30px"></c:if>
            <c:if test="${fn:split(dto.rregion,',')[g.count-1]=='삼척'}"><img src="../resources/images/삼척.png" width="30px"></c:if>
            <c:if test="${fn:split(dto.rregion,',')[g.count-1]=='동해'}"><img src="../resources/images/동해.png" width="30px"></c:if>
      </c:forEach></td>

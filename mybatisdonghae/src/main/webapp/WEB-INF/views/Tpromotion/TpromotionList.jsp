...
<form name="listfrm">
	...
	<tr align="center">
		...
		<td>
			<c:if test="${dto.ticon=='숙소'}"><img src="../resoures/images/zam.png" width="30%"></c:if>
			<c:if test="${dto.ticon=='주위식당'}"><img src="../resoures/images/bob.png" width="30%"></c:if>
			<c:if test="${dto.ticon=='주요행사'}"><img src="../resoures/images/fe.png" width="30%"></c:if>
			<c:if test="${dto.ticon=='액티비티'}"><img src="../resoures/images/act.png" width="30%"></c:if>
		 	<c:if test="${dto.ticon=='사진스팟'}"><img src="../resoures/images/sajin.png" width="30%"></c:if>
